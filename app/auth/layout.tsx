...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col bg-[#000000]">
            {/* Header */}
            <motion.header
            ...
            >
                <div className="text-white font-bold text-xl tracking-wide">UMBRA</div>
                <div className="flex items-center gap-6">
                    <Link href="/">
                        <button className="text-white border border-gray-800 px-5 py-2 hover:bg-gray-900 transition-colors">
                            Home
                        </button>
                    </Link>
                </div>
